class User < ApplicationRecord
  ...
  def followCat(category)
    cat_followed_relationships.create(following_id: category.id)
  end

  def unfollowCat(category)
    cat_followed_relationships.find_by(following_id: category.id).destroy
  end

  # Returns true if the current user is following the other user.
  def isfollowingCat?(category)
    p cat_followed.include?(category)
    p cat_followed
    cat_followed.include?(category)
  end
